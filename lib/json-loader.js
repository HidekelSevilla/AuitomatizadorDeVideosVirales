...
export function parseProject(rawJson) {
  ...
  const project = {
    ...
    // mas lenta NO usar prosody; escribir el guion mas pausado. Solo se aplica si el JSON pone audio.voice_speed.
    voiceSpeed: Number(rawJson.audio && rawJson.audio.voice_speed) || 1,
