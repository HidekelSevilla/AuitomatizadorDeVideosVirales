...
// Prioridad al generar audio: config.fishVoiceId (si lo pegas) > preset > vacio (voz default de Fish).
// Para agregar/editar un preset, pon aqui el reference_id (el id en fish.audio/m/<id>).
export const FISH_PRESETS = Object.freeze({
  esqueletos: { voiceId: "53042fcee6b84e138e72db017d9e50a6", model: "s2-pro" },
});
...
export const DEFAULT_CONFIG = Object.freeze({
  ...
  longBreakEvery: 8,            // cada N generaciones, un descanso largo
  longBreakMinMs: 60000,
  longBreakMaxMs: 150000,
  maxGenerationsPerHour: 25,    // tope por ventana de 60 min; al alcanzarlo, pausa hasta que se libere
