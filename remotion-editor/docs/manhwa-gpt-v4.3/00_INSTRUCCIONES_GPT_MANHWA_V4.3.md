# Instrucciones activas — Generador Manhwa V4.3
...
4. Guion de color por bloque: base, secundario, acento y superficie que lo refleja.
5. Una fila por escena: micro-beat, estrategia semántica, función, ancla sí/no, sujeto, plano, ángulo, eje/mirada, view o ancla textual, referencias, estado, tratamiento, luz y paleta.
...
- Usa neutral dominante más color secundario y acento controlado. Cada ancla muestra un acento saturado con rebote o reflejo; el gris nunca es la única paleta de la Parte.
...
Muestra un instante visible y controla texto. El detalle usa 45–70 palabras descriptivas, el estándar 60–90 y un ancla/master 80–120. Un ancla declara acción, jerarquía, escala, capas, atmósfera, luz y acento cromático reflejado. Sin gutters, multipanel ni extras desenfocados.
