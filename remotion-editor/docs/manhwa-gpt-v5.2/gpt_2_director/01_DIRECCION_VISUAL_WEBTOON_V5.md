...
### Escalera de acción comercial

```text
extreme/deep wide geográfico → medium de anticipación → wide de trayectoria
→ close de impacto → wide de consecuencia → reacción
```

No siempre exige seis paneles, pero geografía, impacto y consecuencia no desaparecen. Movimiento, dirección y contactos deben leerse aun sin efectos.

## 3. Cámara y escala

### TRUE_LONG_SHOT

Solo cuenta si el sujeto completo ocupa 10–25% de altura, el entorno ≥65%, existe aire alrededor, cámara a 12–25 m y hay foreground/midground/background. `Wide` con personaje al 60% es retrato entero. No mezcles `wide` con `tight/close/medium`.

Para 40–50 ventanas exige 4–6: uno de mundo, uno antes de amenaza, dos en clímax y uno de consecuencia. Máximo dos paneles seguidos con sujeto >45%.
...
Este master de 2.5–5 m sirve para legibilidad/geografía cercana, pero **no cuenta** como `TRUE_LONG_SHOT`. Para escala monumental usa 12–25 m y ocupación 10–25%.
...
Al menos dos anclas son `TRUE_LONG_SHOT` o contraste monumental verificable. Cada ancla define ocupación porcentual, foreground, midground, background, fuente, acento y reflejo.
...
La Parte suele tener 20–28% de puntuaciones visuales reales en acción comercial. Cuenta escenas, no porcentaje temático del monólogo. Cards, white/black inset, composite, device, body detail, transición ambiental y reacción de baja densidad cuentan; un full bleed cargado no cuenta por llamarse “master”. Para 38–44 escenas suelen resultar 8–11 respiros; para 45–50, 10–12. Cada respiro declara función; una hoja blanca que parece catálogo no cuenta.
...
Exactamente dos viñetas secuenciales: anticipación/trayectoria y un impacto o reacción dominante. Mismos personajes, eje y cadena de momento; sin texto ni tercera viñeta. Máximo una por secuencia.
...
Una performance pose no cubre más de tres paneles del mismo beat ni emociones incompatibles. Si cambia de miedo a alivio o de percepción a ataque, crea otra pose.
...
Si una cápsula transparente está ocupada, conserva la referencia del ocupante cuando el interior sea visible. Ocúltalo con reflejo, contraluz o silueta; un asiento vacío rompe continuidad.
...
Longitud total: detalle 45–70 palabras, estándar 55–90, interacción/ancla compleja ≤110 y nunca >120. Revisa inglés: prohíbe genitivos como `boots's chest`, sustantivos duplicados y requisitos incompatibles con el crop.
