...
- cut es el default
- acción/impacto 2–9 palabras; reacción/detalle 3–10; estándar 5–14; master máximo 18
- panel normal con más de 18 palabras es inválido para producción visual aunque el contrato mecánico lo acepte
- duración estimada: `palabras × 60 / (150 × edit_speed)`; normal máximo 4.5 s y master 5 s
- cada panel muestra un instante; si cambia sujeto, verbo, posición o emoción, divide la voz sin alterar caracteres
...
El render manhwa conserva una cola final de 0.35–0.60 segundos después del audio/última palabra, sosteniendo la última imagen. Esta cola es de edición; no se añade al `full_script`, no altera timestamps y no genera otra escena.
