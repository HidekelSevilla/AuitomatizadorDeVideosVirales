# Contrato de traspaso STORY_PACKET_V5 — V5.2
...
- scale_plan: [4-6 TRUE_LONG_SHOT con función: mundo, amenaza, geografía, clímax, consecuencia]
...
- `target_runtime_seconds` manda sobre una cuota histórica de palabras.
- Parte 1 no aprueba si termina título después de 8 s, presenta amenaza después de 25 s, agencia después de 45 s o payoff después del 80%.
- `scale_plan` declara función y ocupación; escribir `wide` sin sujeto 10–25% y entorno ≥65% no cuenta.
