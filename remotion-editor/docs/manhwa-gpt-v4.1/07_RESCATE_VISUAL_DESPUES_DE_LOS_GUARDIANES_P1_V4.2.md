...
Usa este documento con las Instrucciones V4.2 y las referencias actualizadas. Adjunta el JSON V4.1 corregido. No adjuntes la guía V3.2.
...
5. scene_43 — CLIFFHANGER: Ijun completo bajo el cono azul del dron; su mano agrietada en foreground bajo, el dron a 2.5 metros y la pared lisa detrás. Composición triangular, institucional y opresiva. Sin raspador como protagonista.
...
4. tabla de shot plan de 43 filas;
5. conteos: closes consecutivos, repetición máxima de prop, distribución de planos, escenas fuera del pasillo y longitud prevista por función.
...
Después del JSON no generes las 42 imágenes. Genera primero solo scenes 01, 06, 08, 15, 21, 22, 24, 30, 34, 35, 39 y 43. La producción completa requiere aprobación visual de esa muestra.
