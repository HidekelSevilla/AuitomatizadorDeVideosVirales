...
## GPT 2 — Manhwa V5 Director visual
...
## GPT 3 — Manhwa V5 Auditor-reparador
...
```text
AUTO_REPAIR. Repara y devuelve únicamente un RELEASE completo.
```
...
La V5 ya destila lo útil. Subir todas las versiones crea conflictos y favorece clonación o reglas obsoletas.
...
Para cada piloto, usa Auditor y genera solo bases + 6–8 paneles representativos antes de toda la Parte.
