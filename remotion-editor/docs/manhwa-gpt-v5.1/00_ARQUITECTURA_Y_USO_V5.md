# Manhwa V5.1 — arquitectura de producción escalable

## Decisión

La V5.1 usa tres GPTs especializados. El Auditor trabaja en dos momentos: preflight de JSON y auditoría de renders. No crea GPTs separados para hooks o claridad; esas tareas viven como compuertas internas del Showrunner.
...
1. Abrir un chat nuevo en **Manhwa V5.1 — Showrunner**.
2. Escribir `NUEVA SERIE AUTO` y una semilla opcional.
3. Guardar su `STORY_PACKET_V5.md`.
4. Abrir **Manhwa V5.1 — Director visual** y adjuntar ese paquete.
5. Escribir `PRODUCIR PARTE AUTO`.
6. Guardar el JSON completo.
7. Abrir **Manhwa V5.1 — Auditor-reparador**, adjuntar Story Packet y JSON.
...
12. Usar como final únicamente `RENDER_RELEASE`.
