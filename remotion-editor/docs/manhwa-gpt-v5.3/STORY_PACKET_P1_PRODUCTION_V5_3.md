...
```json
{
  ...
  "monologue_sha256": "dfad7769e348742066b540a0144908bf58cfd213939f19e272770af9bf23c98e",
...
Era alto, no tenía ojos y seguía atrapado bajo una columna. Una grieta morada latía en su pecho.
...
#### B01 — Hook y título
- beat_id: B01
- narrative_function: promesa retrospectiva, consecuencia personal y título.
...
- cold_viewer_info:
  ...
  - visible_proof: Seo Jun como narrador retrospectivo; la muerte, transferencia y persecución se prometen sin representarlas como hechos ya ocurridos en la línea temporal que empieza en B02.
  - must_not_assume: cómo murió Kang, qué heredó Seo Jun o por qué el Estado lo persigue.
- location_id: hook_retrospective
- location_context: voz retrospectiva referida al mismo túnel, sin compromiso espacial presente ni adelanto diegético obligatorio.
- present_entities: [seo_jun_voiceover]
- spatial_truth:
  - seo_jun_voiceover:
    - position_relation: narrador retrospectivo sin posición diegética obligatoria.
    - inside_container: false
    - contact_with: []
- before_state:
  - seo_jun:
    - condition: todavía sin poder al inicio de la línea temporal de B02.
    - action_status: cuenta desde el futuro inmediato una consecuencia de esta Parte.
  - kang_muyeol:
    - condition: su muerte solo se anuncia; todavía no se representa.
    - action_status: referido, no físicamente presente en el hook.
- atomic_actions:
  - actor: seo_jun_voiceover
    verb: anuncia
    target: muerte de Kang, elección del heredero y persecución estatal
    origin: futuro inmediato de la Parte
    trajectory_or_contact: narración retrospectiva, sin contacto físico visible
    destination: comprensión del oyente frío
    result: queda abierta una promesa concreta.
- after_state:
  - viewer_contract:
    - condition: sabe quién será perseguido y qué transformación debe ver.
    - location: no aplica.
...
- emotional_contract:
  ...
  - required_visible_reaction: presión contenida, mirada consciente del peligro; si se muestra rostro, no neutral.
  - forbidden_neutral_reaction: presentación genérica sin amenaza personal.
- forbidden_implications: [seo_jun dentro de la cápsula, poder ya usado en la línea temporal normal, muerte causada durante la captura, explicación de la conspiración, origen estatal de las Fracturas]
...
- cold_viewer_info:
  ...
  - visible_proof: trabaja con uniforme y herramientas civiles mientras el convoy armado cruza el límite que debía respetar.
...
- present_entities: [seo_jun, park_mira, ryu_haejin, state_agents, capsule_orchestrator, kang_muyeol]
- spatial_truth:
  - seo_jun:
...
- cold_listener: PASS
- word_count: 339
- character_count_with_tags_and_breaks: 2052
