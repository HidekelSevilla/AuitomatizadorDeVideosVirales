...
MANHWA_MODEL_ID = os.environ.get("ELEVENLABS_MANHWA_MODEL_ID", "eleven_multilingual_v2")
MANHWA_V2_SPEED = float(os.environ.get("ELEVENLABS_MANHWA_V2_SPEED", "1.0"))
MANHWA_V2_STABILITY = float(os.environ.get("ELEVENLABS_MANHWA_V2_STABILITY", "0.5"))
MANHWA_V2_SIMILARITY_BOOST = float(os.environ.get("ELEVENLABS_MANHWA_V2_SIMILARITY_BOOST", "0.4"))
MANHWA_V2_STYLE = float(os.environ.get("ELEVENLABS_MANHWA_V2_STYLE", "0.7"))
MANHWA_V2_USE_SPEAKER_BOOST = os.environ.get("ELEVENLABS_MANHWA_V2_USE_SPEAKER_BOOST", "1") != "0"
...
MANHWA_DIALOGUE_EDIT_SPEED = float(os.environ.get("MANHWA_DIALOGUE_EDIT_SPEED", "1.25"))
